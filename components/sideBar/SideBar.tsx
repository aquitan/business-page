...
const SideBar = () => {
  return (
    <div className="flex fixed justify-center gap-4 md:gap-2 p-2 bottom-0 h-[60px] w-full md:w-[80px] flex-row md:flex-col md:relative md:justify-between items-center md:h-full md:p-3">
